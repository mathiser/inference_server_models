...
if __name__ == "__main__":
    ...
    task_name = "Task102_PETMRI"
    downloaded_data_dir = "/mnt/faststorage/hndata/newdata/splited_CTgrid/train/"
    ...
    for p in subdirs(cur, join=False):
        ...
        t1 = join(patdir, "T1dr.nii.gz")
        t2 = join(patdir, "T2dr.nii.gz")
        ...
        shutil.copy(pt, join(target_imagesTr, patient_name + "_0000.nii.gz"))
    ...
    downloaded_data_dir_test = "/mnt/faststorage/hndata/newdata/splited_CTgrid/test/"
    ...
    for p in subdirs(cur, join=False):
        ...
        shutil.copy(pt, join(target_imagesTs, patient_name + "_0000.nii.gz"))
