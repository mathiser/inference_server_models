...
class nnUNetTrainerV2_TOPK1000DA(nnUNetTrainer):
    """
    ...
    def setup_DA_params(self):
        ...
        #self.data_aug_params['max_shifts'] = {'x':2, 'y':2, 'z':2}

        self.data_aug_params['gamma_range'] = (0.7, 1.4)

        self.data_aug_params["num_cached_per_thread"] = 8
