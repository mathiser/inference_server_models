...
from nnunet.network_architecture.deformable_PreUNet import Deform_PreUNet
...
class nnUNetTrainerV2_200_pre_DCN(nnUNetTrainer):
    """
    ...
    def initialize_network(self):
        ...
        self.network = Deform_PreUNet(self.num_input_channels, self.base_num_features, self.num_classes,
