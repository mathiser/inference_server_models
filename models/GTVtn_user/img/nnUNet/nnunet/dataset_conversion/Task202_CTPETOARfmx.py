...
if __name__ == "__main__":
    ...
    task_name = "Task202_CTPETOARfmx"
    downloaded_data_dir = "/mnt/faststorage/hndata/newdata/CT_split/train/"
    ...
    for p in subdirs(cur, join=False):
        ...
        fmx = join(patdir, "PTfmx.nii.gz")
        oar = join(patdir, "OAR.nii.gz")
        ...
        shutil.copy(fmx, join(target_imagesTr, patient_name + "_0002.nii.gz"))
        shutil.copy(oar, join(target_imagesTr, patient_name + "_0003.nii.gz"))
    ...
    downloaded_data_dir_test = "/mnt/faststorage/hndata/newdata/CT_split/test/"
    ...
    for p in subdirs(cur, join=False):
        ...
        shutil.copy(fmx, join(target_imagesTs, patient_name + "_0002.nii.gz"))
        shutil.copy(oar, join(target_imagesTs, patient_name + "_0003.nii.gz"))
