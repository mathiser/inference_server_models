...
if __name__ == "__main__":
    ...
    for p in subdirs(cur, join=False):
        ...
        shutil.copy(fm, join(target_imagesTr, patient_name + "_0002.nii.gz"))
    ...
    for p in subdirs(cur, join=False):
        ...
        shutil.copy(fm, join(target_imagesTs, patient_name + "_0002.nii.gz"))
